...
class MindmapGenerator:
    ...
    def create_mindmap_prompt(self, language: str, text: str, chunk_index: int = 0, total_chunks: int = 1) -> str:
        ...
        language_instructions = {
            ...
            "Urdu": "اردو میں ایک درجہ بند مائنڈ میپ بنائیں",
            ...
            "Korean": "한국어로 계층적 마인드맵을 만들어주세요",
            "Japanese": "日本語で階層的なマインドマップを作成してください",
            "Arabic": "أنشئ خريطة ذهنية هرمية باللغة العربية",
            ...
            "Hebrew": "צור מפת חשיבה היררכית בעברית",
            "Persian": "یک نقشه ذهنی سلسله مراتبی به فارسی ایجاد کنید",
